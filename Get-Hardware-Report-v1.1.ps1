...
If (!(Test-Path "d:\scripts\audit")) {
    New-Item -Path "d:\scripts\audit" -ItemType Directory
}
...
$file = "d:\scripts\audit\$ComputerName" + "-" + $today + "-Report.html"
...
<DIV style = "width:100%;padding-top:10px;padding-bottom: 10px;">
	<DIV style = "float:left;width:49%;">
		<TABLE width=100%>
			<CAPTION>Recent System Events</CAPTION>
			<THEAD>
		  		<TR>
					<TH>Type</TH>
...
write-host "*  Inventory Finished!  *" -ForegroundColor Green
write-host "*************************" -ForegroundColor Green
write-host "File Path: [" $file "]" -ForegroundColor Cyan